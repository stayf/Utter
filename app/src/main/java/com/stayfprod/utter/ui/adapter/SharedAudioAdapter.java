...
public class SharedAudioAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<SharedMusic> mMusicList;
    ...
    public int getItemViewType(int position) {
        return mMusicList.get(position).isDivider ? TYPE_DATE : TYPE_MUSIC;
    }

    @Override
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        holder.itemView.setTag(position);
        SharedMusic sharedMusic = mMusicList.get(position);
    ...
    class MusicHolder extends RecyclerView.ViewHolder {
        ...
        public MusicHolder() {
            ...
            progressView = new DetermineProgressView(mContext);
            //progressView.setId(AndroidUtil.generateViewId());

            unselectedCircleView = new UnselectedCircleView(mContext, false);
            ...
            performerView = new TextView(mContext);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mSelectedMode) {
                        SharedMusic sharedMusic = mMusicList.get(MusicHolder.this.getAdapterPosition());
                        ...
                        if (sharedMusic != null) {
                            ...
                            sharedMediaActivity.forwardCounter.setText(sharedMediaManager.getSelectedMusicList().size() + "");
                        }
                    ...
                    if (!mSelectedMode) {
                        ...
                        translationY.addListener(new AnimatorEndListener() {
                            ...
                            public void onAnimationEnd(Animator animation) {
                                ...
                                View findView = mLinearLayoutManager.findViewByPosition(currPos);
                                SelectedCircleView selectedCircleView = (SelectedCircleView) findView.findViewById(R.id.selected_circle_view);
                                SharedMusic sharedMusic = mMusicList.get(currPos);
                                if (sharedMusic != null) {
                                    SharedMediaManager sharedMediaManager = SharedMediaManager.getManager();
                                    sharedMusic.isSelected = !sharedMusic.isSelected;
                                    if (sharedMusic.isSelected) {
