...
public class AudioMsgView extends AbstractMsgView<AudioMsg> {
    ...
    private String mStorageDownloadedFileSize;
    ...
    public void setValues(AudioMsg record, int i, final Context context, RecyclerView.ViewHolder viewHolder) {
        ...
        mStorageDownloadedFileSize = null;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        String fileSubTitle = mStorageDownloadedFileSize != null ? mStorageDownloadedFileSize : record.fileSubTitle[i];
