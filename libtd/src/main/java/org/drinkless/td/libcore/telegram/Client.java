...
public class Client implements Runnable {
    ...
    public interface ResultHandler {
       void onResult(TdApi.TLObject object, int calledConstructor);
    }
    ...
    private final HashMap<Long, Integer> calledFunctions;
    ...
    private void processResult(long id, TdApi.TLObject object) {
        ...
        try {
            Integer c = calledFunctions.get(id);
            //todo переделать на возврат Integer
            handler.onResult(object, c == null ? -1 : c);
    ...
    private void processQuery(Query query) {
        ...
        calledFunctions.put(currentId, query.function.getConstructor());
        idsI++;
    }
